...
class MyDataset(data.Dataset):
    ...
    def __init__(self, data_dir):
        ...
        self.mc_files = self.rm_too_short_utt(mc_files)   # 把一些太短的句子除去
        self.num_files = len(self.mc_files)               # 获取处理后的数据数量
...
class TestDataset(object):
    """Dataset for testing."""
    def __init__(self, data_dir, wav_dir, src_spk='p229', trg_spk='p272'):
