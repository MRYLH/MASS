...
class Generator(nn.Module):
    """Generator network."""
    def __init__(self, conv_dim=64, num_speakers=10, repeat_num=8):
...
class Discriminator(nn.Module):
    ...
    def __init__(self, input_size=(36, 256), conv_dim=32, repeat_num=5, num_speakers=10):
...
class Classifier(nn.Module):
    ...
    def __init__(self, input_size=(36, 256), conv_dim=32, repeat_num=5, num_speakers=10):
        ...
        self.fc = nn.Linear(num_speakers, num_speakers)
        self.softmax = nn.Softmax(dim=1)
    ...
    def forward(self, x):
        ...
        out_cls_spks = self.softmax(out_cls_spks)    # [16,num_speakers]
        return out_cls_spks
...
if __name__ == '__main__':
    ...
    train_loader = get_loader('/home/yelinhui/yelinhui/quanbu/fakeaudio/voice_conversion/StarGAN-orange/data/mc/train', 16, 'train', num_workers=1)
