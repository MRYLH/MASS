...
fft_bins = n_fft // 2 + 1
num_mels = 37
hop_length = 80                    # 12.5ms - in line with Tacotron 2 paper
...
voc_upsample_factors = (4, 4, 5)   # NB - this needs to correctly factorise hop_length
voc_rnn_dims = 512
voc_fc_dims = 512
