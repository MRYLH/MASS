...
class Paths:
    ...
    def __init__(self, data_path, voc_id, tts_id):
        ...
        self.voc_checkpoints = self.base/'checkpoints_sp_f0'/f'{voc_id}.wavernn'
        ...
        self.voc_output = self.base/'model_outputs'/f'{voc_id}.test'
        # self.voc_output = "/home/NewDisk/yelinhui/yelinhui/Wavenet/WaveRNN-master/respose_wavernn"
